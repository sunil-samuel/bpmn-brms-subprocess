...
public class DiversionTest {
	...
	public void person1() {
		...
		Employee expected = new Employee("Person1", 100, "Entry", 35000.00 * 1.25, "A", false, 0d, 0d);
	...
	public void person2() {
		...
		Employee actual = processEmployee(emp);
		Employee expected = new Employee("Person2", 200, "Junior", 55000.00 * 1.30, "C", true, 100.40d, 40.45d);
	...
	public void person3() {
		...
		Employee actual = processEmployee(emp);
		Employee expected = new Employee("Person3", 300, "Senior", 100000.00 * 1.28, "B", false, 0d, 0d);
	...
	public void person4() {
		...
		Employee actual = processEmployee(emp);
		Employee expected = new Employee("Person4", 400, "Entry", 35000.00 * 1.30, "C", true, 100.40d, 20.45d);
	...
	public void person5() {
		...
		Employee actual = processEmployee(emp);
		Employee expected = new Employee("Person5", 500, "Junior", 55000.00 * 1.25, "A", false, 0d, 0d);
	...
	public void person6() {
		...
		Employee actual = processEmployee(emp);
		Employee expected = new Employee("Person6", 600, "Senior", 100000.00 * 1.28, "B", true, 100.40d, 60.45d);
	...
	private Employee processEmployee(Employee emp) {
		...
		commands.add(CommandFactory.newStartProcess("com.sunilsamuel.employee.rules.process"));
